...
public class ProblemasMatematicosWindow extends JFrame {
	...
	private void componentesCriar() {
		...
		label8_3.setForeground(VERY_DARK_GREEN);
		...
		btnGerar = new JButton(new AbstractAction("Gerar") {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String senha = OperacoesMatematicas.GeradorDeSenhas(chkUppercase.isSelected() ? true : false,
						chkLowercase.isSelected() ? true : false, chkNumbers.isSelected() ? true : false,
						chkSymbols.isSelected() ? true : false, (Integer)spnTamanho.getValue());
